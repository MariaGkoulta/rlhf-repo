...
class OnlineRLHF:
    ...
    def calculate_model_uncertainty(self, trajectory_pairs, n_samples=10):
        ...
        with torch.no_grad():
            for traj1, traj2, _ in trajectory_pairs:
                ...
                for _ in range(n_samples):
                    ...
                    r2 = self.reward_model(states2_tensor, actions2_tensor)
                    r1_samples.append(r1)
                    r2_samples.append(r2)

                # calculate the variance of the samples
                var1 = np.var(r1_samples)
                var2 = np.var(r2_samples)
                pair_uncertainty = var1 + var2
    ...
    def train_reward_model(self, preference_pairs, epochs=5):
        ...
        for epoch in range(epochs):
            ...
            uncertainty = self.calculate_model_uncertainty(preference_pairs)
            epoch_uncertainties.append(uncertainty)
            print(f"Model uncertainty: {uncertainty:.4f}")

        return epoch_losses[-1], epoch_uncertainties[-1]
    ...
    def train(self, iterations=20, trajectories_per_iter=200, preference_pairs=200, 
        ...
        for iter in range(iterations):
            ...
            reward_loss, uncertainty = self.train_reward_model(pairs, epochs=reward_epochs)
            ...
            if iter % 4 == 0 or iter == iterations - 1:
                ...
                for traj, true_reward in self.trajectories_history:
                    with torch.no_grad():
